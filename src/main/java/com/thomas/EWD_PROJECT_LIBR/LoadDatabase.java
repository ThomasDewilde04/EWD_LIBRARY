...
public class LoadDatabase {
    ...
    public CommandLineRunner initDatabase(BoekRepo boekRepo, UserRepo userRepo, AuteurRepo auteurRepo, LocatieRepo locatieRepo) {
        ...
        boek1.setIsbnNummer("9789025742843");
        ...
        boek2.setIsbnNummer("9788408191858");
        boek2.setPrijs(8.99);
        ...
        boek3.setIsbnNummer("9789045110950");
        ...
        boek4.setIsbnNummer("9789026125690");
        ...
        boek5.setIsbnNummer("9782266260770");
        boek5.setPrijs(8.29);
